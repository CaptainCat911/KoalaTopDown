...
/// <summary>
/// Держатель оружия (бомбы), также поворачивается для поворота оружия
/// </summary>
...
{    
    ...
    [HideInInspector] public BombWeapon currentWeapon;  // текущее оружие 
    ...
    private void Update()
    {
        ...
        // Стрельба
        if (Input.GetKey(KeyCode.G) || Input.GetMouseButton(2))
        {
        ...
        if (Input.GetKeyDown(KeyCode.V) || Input.GetKeyDown(KeyCode.Z))         // смена бомбы
        {
